                        ...
                        <div className='review_info' key={i}>
                            <div className='review_author'>
                                <div className='author'>
                                    {apiData.results[i].author !== undefined? apiData.results[i].author:null}</div>
                                <div className='created_date'>{apiData.results[i].created_at}</div> 
                            
                            </div>
                            <div className='review_content'>
                                <div className='content'>
                                    {apiData.results[i].content}</div>
                            </div>
