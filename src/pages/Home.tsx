...
const {popularMovie, topRateMovie, isComingMovie} = useSelector((state:any)=>{return state.movies.data})
...
useEffect(()=>{
    ...
    return (
        <div className='home'>
            {loading === true?
            <ClipLoader className='spinner' color={'purple'} loading={loading} cssOverride={override} size={150}/>
            : 
